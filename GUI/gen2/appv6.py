...
layout = [
    [sg.Text('Hindi Fable Story Question Generator', font=('Google Sans', 30, 'bold'), justification='center', size=(40, 1))],
...
window = sg.Window('Hindi Fable Story Question Generator', layout, finalize=True, background_color='#282a36')
