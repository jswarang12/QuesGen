...
layout = [
    [sg.Text('Select Story File:'), sg.Input(key='-STORY_FILE-'), sg.FileBrowse()],
    [sg.Button('Generate Questions', key='-GENERATE-')],
    [sg.Output(size=(80, 20), key='-OUTPUT-')]
]

# Create the GUI window
window = sg.Window('Hindi Fable Story Question Generator', layout)
